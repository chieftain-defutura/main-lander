export const OriginData = [
  ...
  {
    year: "2020",
    title: "School Students ( SSLC )",
    description:
      "Upgrading our potential, we improved our teaching methods to better assist students preparing for board exams with specialized assessments. We provided support to those who faced personal and academic challenges which worked out really well, every student achieved their best performance.",
  },
  {
    year: "2021",
    title: "School Students ( HSC )",
    description:
      "With dedication and confidence, we started to train 12th std students with a student strength of 60.We encouraged active learning towards students to become self-directed, independent, and critical thinkers.",
  },
  {
    year: "2022",
