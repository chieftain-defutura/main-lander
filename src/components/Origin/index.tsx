      ...
      <div className="origin">
        <div className="mx pad">
          <div className="origin-container">
            ...
            <p>
              A couple of years ago, two like-minded friends embarked on a
              journey to create a space for excellence. Driven by a shared
              vision, they gave rise to Dehustle Institute, dedicated to
              becoming a hub of talent and mastery.
            </p>
          </div>
